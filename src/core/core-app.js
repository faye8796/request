 ...
 * 
 * @description 전체 애플리케이션의 초기화, 라우팅, 에러 처리를 담당하는 핵심 모듈
 * @dependencies CONFIG, SupabaseAPI, AuthManager, Utils
...
const App = {
    // 초기화
    async init() {
        console.log('🚀 세종학당 문화교구 신청 플랫폼 시작 (v2.0.0)');
...
if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    ...
    console.log('  • showDebugInfo() - 디버그 정보 확인');
    console.log('  • checkSystemHealth() - 시스템 상태 확인');
    console.log('  • showAppInfo() - 앱 정보 확인');
}

// Claude AI 친화적 구조임을 표시
console.log('🤖 Claude AI 최적화 구조로 실행 중 (v2.0.0)');
